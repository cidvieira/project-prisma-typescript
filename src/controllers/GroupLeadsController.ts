...
export class GroupLeadsController {
  constructor (
    private readonly groupsRepositoy: GroupsRepository,
  ...
  addLead: Handler = async (req, res, next) => {
    try {
      ...
      const updatedGroup = await this.groupsRepositoy.addLead(groupId, leadId)
  ...
  removeLead: Handler = async (req, res, next) => {
    try {
      ...
      const updatedGroup = await this.groupsRepositoy.removeLead(groupId, leadId)
